...
import cn.paindar.academymonster.ability.AIDirectedShock;
 ...
 */
public class EntityAIDirectedShock extends EntityAIBase
{
    private final EntityLiving speller;
    private EntityLivingBase target;
    private AIDirectedShock skill;

    public EntityAIDirectedShock(EntityLiving speller,AIDirectedShock skill)
    {
