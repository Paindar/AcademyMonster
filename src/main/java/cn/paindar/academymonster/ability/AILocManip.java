...
public class AILocManip extends BaseSkill
{
    ...
    public void spell()
    {
        ...
        {
            EntityMagManipBlock entity=  new EntityMagManipBlock(speller, 10,this);
    ...
    public void onTick()
    {
        ...
        for(Map.Entry<EntityMagManipBlock,Double> pair:list.entrySet())
        {
            ...
            Vec3 end=Vec3.createVectorHelper(speller.posX+Math.sin(rad)*pair.getValue(),speller.posY+2,speller.posZ+Math.cos(rad)*pair.getValue());
